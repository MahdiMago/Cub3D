...
SRC = src/main.c src/player.c src/raycast.c src/textures.c src/draw_textured.c src/draw_utils.c \
	src/raycast_utils.c src/init_main.c src/raycast_2.c src/close.c src/player_utils.c src/parsing/parser.c \
	src/parsing/parser_utils.c src/parsing/parser_utils_2.c src/draw_column.c 
OBJ = $(SRC:.c=.o)
